        ...
        @if(Request::get('complete'))
            ...
            @php
                ...
                <div class="flex flex-col items-center p-10 mx-auto mt-8 w-full max-w-lg bg-white rounded-xl border shadow-xl border-zinc-100">
                    <h1 class="text-2xl font-semibold text-black">Instalare reușită 🎉</h1>
                    <p class="mt-5 text-zinc-500">Apasă pe butonul Continuă pentru a vedea noua ta aplicație SAAS.</p>
        ...
        @else
            ...
            <div class="flex flex-col justify-center items-center w-screen h-screen">
                ...
                <div class="flex flex-col items-center p-10 mx-auto mt-8 w-full max-w-lg bg-white rounded-2xl border shadow-sm border-zinc-100">
                    <h1 class="text-2xl font-semibold text-black">Bine ai venit la Wave</h1>
                    <p class="mt-5 text-zinc-500">Dacă ești gata să începi, apasă pe butonul 'Instalează Wave' de mai jos. În viitor, acest ecran de instalare va avea câteva opțiuni de configurare.</p>
