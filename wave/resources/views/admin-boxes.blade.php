        ...
        <div class="bg-green-400 panel widget center bgimage" style="border-radius:6px; position:relative; overflow:hidden; background-image: linear-gradient(to right, #6a11cb 0%, #2575fc 100%);">
            <div style="width:100%; height:40px; display:flex; position:relative; z-index:20; justify-content: start; color:#fff;">
                ...
                <div class="relative" style="margin-left:14px; text-align:left;">
                    <p style="color:#ffffff; display:block; margin:0px; font-weight:500; font-size:17px; line-height:17px; margin-top:3px; margin-bottom:4px;">Publică pe DO</p>
                    <p style="display:block; color:#dce9fe; text-align:left; line-height:14px; margin:0px;">Publică pe DigitalOcean</p>
                </div>
    ...
    <div class="col-xs-12 col-md-6 col-lg-4">
        <div class="bg-green-400 panel widget center bgimage" style="border-radius:6px; position:relative; overflow:hidden; background-image: linear-gradient(to right, #b8cbb8 0%, #b8cbb8 0%, #b465da 0%, #cf6cc9 33%, #ee609c 66%, #ee609c 100%);">
            <div style="width:100%; height:40px; display:flex; position:relative; z-index:20; justify-content: start; color:#fff;">
                ...
                <div class="relative" style="margin-left:14px; text-align:left;">
                    <p style="color:#ffffff; display:block; margin:0px; font-weight:500; font-size:17px; line-height:17px; margin-top:3px; margin-bottom:4px;">Urmărește și învață</p>
                    <p style="display:block; text-align:left; line-height:14px; margin:0px;">Screencast-uri pentru a învăța CCB</p>
                </div>
    ...
    <div class="col-xs-12 col-md-6 col-lg-4">
        <div class="bg-green-400 panel widget center bgimage" style="border-radius:6px; position:relative; overflow:hidden; background-image: url('{{ Storage::url('/settings/April2021/tails-bg.png') }}'); background-size:cover;">
            <div style="width:100%; height:40px; display:flex; position:relative; z-index:20; justify-content: start; color:#fff;">
                ...
                <div class="relative" style="margin-left:14px; text-align:left;">
                    <p style="color:#ffffff; display:block; margin:0px; font-weight:500; font-size:17px; line-height:17px; margin-top:3px; margin-bottom:4px;">Creează o pagină de prezentare</p>
                    <p style="display:block; text-align:left; color:#dce9fe; line-height:14px; margin:0px;">Generator de pagini Tailwind</p>
                </div>
