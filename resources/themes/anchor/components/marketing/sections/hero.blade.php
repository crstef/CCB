        ...
        <div class="w-full lg:w-1/2">
            <div class="w-full mb-2 lg:mb-0 max-w-2xl mx-auto lg:mx-0">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-6 justify-center">
                    ...
                    <a href="{{ route('galerie-foto') }}" class="group relative bg-gray-600 hover:bg-black text-white px-8 py-4 rounded-2xl shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center min-h-[60px] border-2 border-gray-600 hover:border-black">
                        {{-- Content --}}
                        <div class="flex items-center">
                            <svg class="w-6 h-6 mr-3 transition-transform group-hover:rotate-12 duration-300 text-white stroke-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                            </svg>
                            <span class="font-bold text-xl text-white tracking-wide">Galerie Foto</span>
                        </div>
                    </a>
                    
                    {{-- Video Gallery Button --}}
                    <a href="{{ route('galerie-video') }}" class="group relative bg-gray-600 hover:bg-black text-white px-8 py-4 rounded-2xl shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center min-h-[60px] border-2 border-gray-600 hover:border-black">
                        {{-- Content --}}
                        <div class="flex items-center">
                            <svg class="w-6 h-6 mr-3 transition-transform group-hover:scale-110 duration-300 text-white stroke-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                            </svg>
                            <span class="font-bold text-xl text-white tracking-wide">Galerie Video</span>
                        </div>
                    </a>
                </div>
            </div>
