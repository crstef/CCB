    ...
    <div class="flex flex-col items-center justify-between flex-1 w-full max-w-2xl gap-2 px-8 pt-32 mx-auto text-left md:px-12 xl:px-20 lg:pt-32 lg:pb-4 lg:max-w-7xl lg:flex-row">
        ...
        <div class="w-full lg:w-1/2">
            <div class="w-full mb-2 lg:mb-0 max-w-2xl mx-auto lg:mx-0">
                ...
                @livewire('media.media-carousel', ['height' => 'h-[400px] lg:h-[450px]'])
                
                {{-- Premium Gallery Navigation Buttons --}}
                <div class="flex flex-col sm:flex-row gap-4 mt-6 justify-center">
                    {{-- Photo Gallery Button --}}
                    <a href="/galerie-foto" class="group relative overflow-hidden bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-4 rounded-2xl shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105 flex items-center justify-center">
                        {{-- Background Pattern --}}
                        <div class="absolute inset-0 bg-blue-600/20 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        
                        {{-- Content --}}
                        <div class="relative flex items-center">
                            <svg class="w-6 h-6 mr-3 transition-transform group-hover:rotate-12 duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                            </svg>
                            <span class="font-semibold text-lg">Galerie Foto</span>
                        </div>
                    </a>
                    
                    {{-- Video Gallery Button --}}
                    <a href="/galerie-video" class="group relative overflow-hidden bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 py-4 rounded-2xl shadow-lg hover:shadow-purple-500/25 transition-all duration-300 hover:scale-105 flex items-center justify-center">
                        {{-- Background Pattern --}}
                        <div class="absolute inset-0 bg-purple-600/20 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        
                        {{-- Content --}}
                        <div class="relative flex items-center">
                            <svg class="w-6 h-6 mr-3 transition-transform group-hover:scale-110 duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                            </svg>
                            <span class="font-semibold text-lg">Galerie Video</span>
                        </div>
                    </a>
                </div>
            </div>
